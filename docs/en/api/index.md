...
| `resolveUrl` | [`MawyUrlResolver`](#mawyurlresolver) | — | Where a relative URL in the document points. |
...
It reaches a link's `href`, a picture's source, and the same two inside raw HTML under [`html="sanitize"`](#mawyhtmlpolicy).
