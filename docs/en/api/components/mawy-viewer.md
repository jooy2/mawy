...
| `headingAnchors` | `boolean` | `true` | Whether this viewer uses the page's address to name a heading: the `#` beside each heading, the address an outline entry writes, and going to a heading the address names. |
