 ...
 * heading was given, the pictures it points at — should not be made to pull in
 * a component to get at them. Nothing here draws anything and nothing here is
 * a React component, so this reaches a build script and a server as readily as
 * it reaches a page.
 *
 ...
 *
 * The Flutter package exports the same things, for the same reason and under
 * the same names. This is the half of "one library shipped twice" that was
 * only true of the drawing.
 *
...
export { imageUrls } from './internal/markdown/images.js';
export type {
  MdAlertKind,
  MdAlign,
  MdBlock,
