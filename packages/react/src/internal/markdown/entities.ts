 ...
 * turn up in prose, the whole of the Latin-1 block, and the numeric forms,
 * which are the general escape hatch.
 */
...
const NAMED: Record<string, string> = {
  ...
  diams: '♦',
  /*
   * The Latin-1 block. `&ouml;` and `&eacute;` are what a document written in a
   * European language reaches for, and they are the reason this table is bigger
   * than the punctuation and the arrows: an author who wrote `Fr&ouml;hlich`
   * meant a word rather than nine characters of markup.
   */
  NonBreakingSpace: ' ',
  iexcl: '¡',
  curren: '¤',
...
// does not exist.
const REFERENCE = /&(?:#[Xx]([\da-fA-F]{1,6})|#(\d{1,7})|([A-Za-z][A-Za-z\d]{1,31}));/g;
